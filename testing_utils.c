...
const char* getTokenTypeName(TokenType type) {
    switch (type) {
        case TOKEN_TYPE_EMPTY: return "EMPTY";
        ...
        case TOKEN_TYPE_INTEGER_VALUE: return "INTEGER_VALUE";
        case TOKEN_TYPE_DOUBLE_VALUE: return "DOUBLE_VALUE";
        case TOKEN_TYPE_STRING_VALUE: return "STRING_VALUE";
        case TOKEN_TYPE_EQ: return "EQUAL";
        case TOKEN_TYPE_NEQ: return "NOT_EQUAL";
        case TOKEN_TYPE_LTH: return "LESS_THAN";
        case TOKEN_TYPE_LEQ: return "LESS_OR_EQUAL";
        case TOKEN_TYPE_GTH: return "GREATER_THAN";
        case TOKEN_TYPE_GEQ: return "GREATER_OR_EQUAL";
        case TOKEN_TYPE_ASSIGN: return "ASSIGN";
        ...
        case TOKEN_TYPE_RIGHT_CURLY_BR: return "RIGHT_CURLY_BRACE";
        ...
        case TOKEN_TYPE_EXPR: return "EXPRESSION";
        case TOKEN_TYPE_DOLLA: return "DOLLAR";
...
const char* getKeywordName(Keyword keyword) {
    switch (keyword) {
        case KEYWORD_I_32: return "i32";
        case KEYWORD_I_32_NULL: return "?i32";
        case KEYWORD_F_64: return "f64";
        case KEYWORD_F_64_NULL: return "?f64";
        case KEYWORD_U_8_ARRAY: return "[]u8";
        case KEYWORD_U_8_ARRAY_NULL: return "?[]u8";
        ...
        case KEYWORD_UNDERSCORE: return "_";
        case KEYWORD_MAIN: return "main";
        
        case KEYWORD_IMPORT: return "@import";
        case KEYWORD_IFJ: return "ifj";
        
        case KEYWORD_STRING: return "string";
        case KEYWORD_LENGTH: return "length";
        case KEYWORD_CONCAT: return "concat";
        case KEYWORD_SUBSTRING: return "substring";
        case KEYWORD_STRCMP: return "strcmp";
        case KEYWORD_ORD: return "ord";
        case KEYWORD_CHR: return "chr";
        
        case KEYWORD_WRITE: return "write";
        case KEYWORD_READSTR: return "readstr";
        case KEYWORD_READI32: return "readi32";
        case KEYWORD_READF64: return "readf64";
        
        case KEYWORD_I2F: return "i2f";
        case KEYWORD_F2I: return "f2i";
...
void printTokenInfo(Token* token) {
    ...
    switch (token->type) {
        ...
        case TOKEN_TYPE_KEYWORD:
            printf("%s (%s)\n", getTokenTypeName(token->type), getKeywordName(token->attribute.keyword));
            break;
